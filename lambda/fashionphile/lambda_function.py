...
def lambda_handler(event, context):
    ...
    for collection in COLLECTIONS:
        ...
        for product_div in product_divs:
            brand_name_tag = product_div.find(None, attrs={"itemprop": "brand"})
            brand_name = brand_name_tag.get("content")
            
            product_name_tag = product_div.find(None, attrs={"class": "hitTitle"})
            ...
            condition_tag = product_div.find(None, attrs={"class": "condition"})
